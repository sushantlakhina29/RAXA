    ...
    <body>
        ...
        try {
           ...
           t6="";
            ...
            sto.executeUpdate("insert into querylist(query,name,contactno,address,emailid,reply) values('" + t1 + "','" + t2 + "','" + t3 + "','" + t4 + "','" + t5 + "','" + t6 + "')");
          //  sto.executeUpdate("insert into RCDETAILS values('" + t1 + "','" + t2 + "','" + t3 + "','" + t4 + "','" + t5 + "','" + t6 + "','" + t7 + "','" + t8 + ','" + t9 + "','" + t10 + "')");
            out.print("<center><font size=6 color=green>THANKS FOR QUERY</font></center>");
            con.close();
        } catch(Exception e) {
        }
