...
<html>
    ...
    <body>
        ...
        try {
           ...
           t9=request.getParameter("t9");
           t10=request.getParameter("t10");
            Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
            Connection con=DriverManager.getConnection("jdbc:odbc:db","","");
            Statement sto=con.createStatement();
            
  sto.executeUpdate("insert into insurance values('" + t1 + "','" + t2 + "','" + t3 + "','" + t4 + "','" + t5 + "','" + t6 + "','" + t7 + "','" + t8 + "','" + t9 + "','" + t10 + "')");           

                       out.print("<center><font size=6 color=green>Insurance Details submitted</font></center>");
            con.close();
        } catch(Exception e) {
        }
